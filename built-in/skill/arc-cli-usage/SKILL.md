...
# arc-kit 使用指南 / arc-kit Usage Guide
...
- 总览 / Overview：`arc status`
- provider：`arc provider` 或 `arc provider list`
- 已装 skill / Installed skills：`arc skill list --installed`
- market：`arc market list`

## 必须记住的语义 / Key Semantics
...
## 容易答错的项目级行为 / Common Project-Level Pitfalls
...
## 能力速查 / Capability Quick Reference
